...
var controls,controller1,controller2;
var pointLight;
...
function init() {
	...
	var dummy = new THREE.Camera();
		...
		dummy.position.set( 76,200, 688 );
		dummy.lookAt( scene.position );
		scene.add( dummy );

		camera = new THREE.PerspectiveCamera( 70, window.innerWidth / window.innerHeight, 0.1, 12000 );camera.up = new THREE.Vector3(0,1,0);
...
//camera.lookAt( new THREE.Vector3(0,364,0));
 // scene.position.set(-76, -364, -588);
